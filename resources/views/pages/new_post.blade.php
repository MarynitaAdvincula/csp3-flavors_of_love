...
<form action="/new_post" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group row">
    <label for="food_blog" class="col-sm-2 col-form-label">Food Blog ?</label>
    <div class="col-sm-10">
      <div class="col-sm-1">
        <label class="switch">
        <input name="travel_food" type="checkbox">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <textarea class="form-control" name="postContent" id="post" placeholder="Post"> </textarea>
    </div>
  </div>
